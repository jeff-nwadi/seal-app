...
function HexagonBackground({
  ...
  return (
    <div
      ...
      className={cn(
        'relative size-full overflow-hidden bg-[var(--color-bg,#0d0d0d)]',
        className,
      )}
      {...props}
    >
              ...
              (_, colIndex) => (
                <div
                  ...
                  className={cn(
                    ...
                    "before:content-[''] before:absolute before:top-0 before:left-0 before:w-full before:h-full before:bg-[var(--color-bg,#0d0d0d)] before:opacity-100 before:transition-all before:duration-1000",
                    "after:content-[''] after:absolute after:inset-[var(--hexagon-margin)] after:bg-[var(--color-bg,#0d0d0d)]",
