...
type CheckboxProps = HTMLMotionProps<'button'> &
  Omit<React.ComponentProps<typeof CheckboxPrimitive.Root>, 'asChild'> & {
    /**
     * v1 of the per-package Radix primitives doesn't have the `render` prop
     * that animate-ui's v2-style source uses. We forward the user's motion
     * props onto the motion-wrapped button child instead.
     */
  };
